...
> **표·록은 고르지 마십시오.** 이들은 **2차** — 1차 문서에서 계산되는 뷰입니다([방법론 「분류의 세 축」](methodology.md#분류의-세-축)). 재고현황표를 스케치하려 하면 시간이 사라지고, 그럴 필요도 없습니다. 입고확인서와 출고확인서가 있으면 재고현황표는 따라 나옵니다.
>
> 표·록이 나오면 한 줄만 적고 넘어갑니다 — *"그건 어느 서류들을 모아 보는 건가요?"*
