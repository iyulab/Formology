...
다부서 통합의 경우 **도메인별로 워크숍을 반복한 뒤 통합 세션을 따로** 여는 방식이 됩니다. 다만 정직하게 적습니다 — **이 확장 절차는 아직 충분히 검증되지 않았습니다.** 아래 본문이 기술하는 것은 단일 도메인 절차이며, 실측 사례([사례 연구](casestudy.md))도 단일 도메인입니다.
